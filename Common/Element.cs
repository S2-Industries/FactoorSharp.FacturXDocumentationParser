...
namespace FactoorSharp.FacturXDocumentationParser.Common
{
    ...
    public sealed class Element
    {
        ...
        public Cardinality XsdCardinality { get; set; }
        ...
        public List<string> BusinessRules { get; internal set; } = new List<string>();
        public Cardinality CiiCardinality { get; internal set; }
